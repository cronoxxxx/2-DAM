...
public class GestionMensajes {
    ...
    @Async
    public CompletableFuture<Either<ErrorApp, List<MensajePrivado>>> obtenerYDesencriptarMensajesPrivados(GrupoPrivado grupoPrivado, Usuario receptor, String userPass) {
        return CompletableFuture.completedFuture(
